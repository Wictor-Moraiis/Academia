...
public class FuncionarioController {
    ...
    public ResponseEntity<FuncionarioResponseDto> cadastrar(@RequestPart("dados") @Valid FuncionarioDto dto,
    ...
    public ResponseEntity<FuncionarioResponseDto> atualizar(@PathVariable Integer funcionarioId,
    ...
    public ResponseEntity<FuncionarioResponseDto> buscarPorId(@PathVariable Integer funcionarioId) {
